...
window.setTimeout("window.location='art'",1200);
});
document.getElementById("btn_select").addEventListener("click", function(){
window.setTimeout("window.location='poem'",1200);
});

document.getElementById("btn_music").addEventListener("click", function(){
window.setTimeout("window.location='music-ana'",1200);
});
