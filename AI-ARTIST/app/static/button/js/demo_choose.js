...
window.setTimeout("window.location='uppic'",1200);

});

document.getElementById("btn_style").addEventListener("click", function(){
window.setTimeout("window.location='select'",1200);
});

document.getElementById("btn_magic").addEventListener("click", function(){
    var form = $("<form>");   //定义一个form表单 

    form.attr('method','post');  
     form.attr('action','style');  
